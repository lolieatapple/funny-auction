...
contract('FunnyAuction', ([alice, bob, carol, dev, minter, p1, p2, p3]) => {
  ...
  it.only('should allow deposit', async () => {
  ...
  it.only('should allow withdraw', async () => {
  ...
  it.only('should success game round 1', async () => { 
    let goods = await this.sc.calcGoodsValue();
    console.log('goods', goods.toString());
    ...
    await this.sc.offer(web3.utils.toWei('1'), {from: p3});
  });
